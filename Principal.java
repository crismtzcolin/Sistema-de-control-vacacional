...
public class Principal extends JFrame implements ActionListener{
	...
	private JMenuItem miCalculo,miAzul,miNegro,miMorado,miElCreador,miSalir,miNuevo;
	...
	public Principal(){
		...
		menuOpciones.setBackground(new Color(0,0,255));
		menuOpciones.setFont(new Font("Andale Mono", 1, 14));
		menuOpciones.setForeground(new Color(0,0,0));
		mb.add(menuOpciones);

		menuCalcular = new JMenu("Calcular");
		menuCalcular.setBackground(new Color(0,0,255));
		menuCalcular.setFont(new Font("Andale Mono", 1, 14));
		menuCalcular.setForeground(new Color(0,0,0));
		mb.add(menuCalcular);

		menuAcercaDe = new JMenu("Acerca de");
		menuAcercaDe.setBackground(new Color(0,0,255));
		menuAcercaDe.setFont(new Font("Andale Mono", 1, 14));
		menuAcercaDe.setForeground(new Color(0,0,0));
		mb.add(menuAcercaDe);

		menuColorFondo = new JMenu("Color de fondo");
		menuColorFondo.setBackground(new Color(0,0,255));
		...
		labelLogo.setBounds(5,5,150,146);
		add(labelLogo);
		...
		labelTitle.setBounds(45,40,900,250);
		...
		labelFooter = new JLabel("©2023 ProgramaLAB | Todos los derechos reservados");
	...
	public void actionPerformed(ActionEvent e){
		if(e.getSource()==miCalculo){
			...
			String APaterno =txtAPaternoTrabajador.getText();
			String AMaterno =txtAMaternoTrabajador.getText();
			String Departamento =comboDepartamento.getSelectedItem().toString();
			String Antiguegad =comboAntiguedad.getSelectedItem().toString();

			if(nombreTrabajador.equals("") || APaterno.equals("") || AMaterno.equals("") || Departamento.equals("") || Antiguegad.equals("")){
				JOptionPane.showMessageDialog(null, "Debes de llenar todos los campos");
			}else{
				if(Departamento.equals("Atención al Cliente")){
					if(Antiguegad.equals("1 año de servicio")){
						textarea1.setText("\n El trabajador "+nombreTrabajador+" "+APaterno+" "+AMaterno+"\n quien labora en "+Departamento+ " con "+Antiguegad+"\n recibe 6 dias de vacaciones.");
					}
					if(Antiguegad.equals("2 a 6 años de servicio")){
						textarea1.setText("\n El trabajador "+nombreTrabajador+" "+APaterno+" "+AMaterno+"\n quien labora en "+Departamento+ " con "+Antiguegad+"\n recibe 14 dias de vacaciones.");
					}
					if(Antiguegad.equals("7 años de servicio")){
		...
		if(e.getSource()==miElCreador){
			JOptionPane.showMessageDialog(null, "Desarrollado por Cristian Martínez Colín & ProgramaLAB \n www.youtube.com/@programalab");
		}
	}
